...
public class BillGenerator {
    ...
    public static void generateTxtBill(String customerId, String customerName, CustomerUsage usage) {
        String outputFileName = OUTPUT_DIR + customerId + "_bill.txt";
        ...
        generatePdfBill(customerId, customerName, usage, daytimeCost, nighttimeCost, totalCost);
        saveBillToDatabase(customerId, customerName, usage);
    }

    private static void generatePdfBill(String customerId, String customerName, CustomerUsage usage, double daytimeCost, double nighttimeCost, double totalCost) {
        String outputFileName = OUTPUT_DIR + customerId + "_bill.pdf";
